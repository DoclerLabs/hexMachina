...
haxe -cp ./hexcore/src -cp ./hexreflection/src -cp ./hexinject/src -cp ./hexmvc/src -cp ./hexioc/src -cp ./hexservice/src -cp ./hexannotation/src -cp ./hexstate/src -cp ./hexunit/src -cp ./hexdoctheme/src -cp ./hexdsl/src --macro "ImportAll.run()" --no-output -xml xml/neko.xml -php bin
